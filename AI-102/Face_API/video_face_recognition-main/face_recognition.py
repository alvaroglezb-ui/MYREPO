...
# Variables
path = "C:/Users/BD828FX/Desktop/Git/AI-102/Face_API/video_face_recognition-main/"

credential = json.load(open('{}\\json_key.json'.format(path)))
KEY = credential['KEY']
...
def criar_grupo(grupo):
    try:
        face_client.person_group.get(person_group_id=grupo,return_recognition_model=False)
